...
def radius_graph_pbc(
    atom_pos, natoms, cell, radius, max_num_neighbors_threshold, pbc=[True, True, True]
):
    ...
    print('natoms', natoms.sum())
    print('num_cells', num_cells, unit_cell.shape, unit_cell_per_atom.shape, unit_cell_batch.shape)
    ...
    print('unit_cell', unit_cell_per_atom.shape, unit_cell_per_atom.min(), unit_cell_per_atom.max())
